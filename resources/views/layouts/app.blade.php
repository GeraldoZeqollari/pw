    ...
    >
      <g id="main_logo">
        ...
        <g id="paintbrush">
          ...
          />
          <path
            d="M28.619 32.61L28.6584 14.7943L27.6253 14.7916L27.5858 32.6073L28.619 32.61Z"
            fill="black"
          />
          <path
            d="M34.266 31.8512L34.3015 15.7742L30.0099 15.7631L29.9743 31.8401L34.266 31.8512Z"
            fill="black"
          />
          <path
        ...
        <path
          id="letter_a"
          d="M112.148 12H108.73L101 34.59H105.394L110.561 19.1476L115.321 34.59H120L112.148 12Z"
          fill="black"
        />
        <path
          id="letter_c"

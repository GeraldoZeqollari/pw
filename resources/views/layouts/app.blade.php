      ...
      <a href={{ route('home') }}>
        <svg width="140" height="35" viewBox="0 0 140 35" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="main_logo">
            ...
            <g id="paintbrush">
              <path
                d="M34.3385 15.6922C35.7864 15.0434 36.4603 11.5908 36.6163 9.94556L37.3911 9.94756L37.3565 25.6167L36.5816 25.6147C36.5851 24.0407 36.1395 20.681 34.3293 19.8349C32.0666 18.7773 29.5019 19.5005 27.7726 19.818C27.3269 19.8998 21.3051 21.3825 18.3495 22.1977C13.5 22.8506 12.0698 19.6915 12.0001 18.2962C11.9791 13.4021 16.2373 12.9624 18.3691 13.3542L27.7818 15.6753C29.3641 15.9513 32.8906 16.341 34.3385 15.6922Z"
                fill="black" />
            ...
            <path id="letter_a" d="M115.148 6H111.73L104 28.59H108.394L113.561 13.1476L118.321 28.59H123L115.148 6Z"
              fill="black" />
            <path id="letter_c" d="M103 27C97.4772 27 93 22.7467 93 17.5C93 12.2533 97.4772 8 103 8" stroke="black"
              stroke-width="4" />
          </g>
        </svg>

        <svg width="60" height="35" viewBox="0 0 60 35" class="svg_logo_mobile" fill="none"
          ...
          <g id="main_logo">
            ...
            <path id="letter_a_mobile" d="M48.1478 6H44.7302L37 28.59H41.394L46.561 13.1476L51.3212 28.59H56L48.1478 6Z"
              fill="black" />
            <path id="letter_c_mobile" d="M36 27C30.4772 27 26 22.7467 26 17.5C26 12.2533 30.4772 8 36 8" stroke="black"
              stroke-width="4" />
          </g>
        </svg>
